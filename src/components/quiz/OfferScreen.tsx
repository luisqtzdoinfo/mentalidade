...
export function OfferScreen() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto flex flex-col items-center text-center p-4 md:p-8 animate-in fade-in duration-1000">
      <div className="w-full max-w-3xl mx-auto text-left md:text-center">
      ...
      <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 w-full my-8">
        ...
        <div className="w-full md:w-3/5 text-left space-y-6">
          <div>
            <h3 className="flex items-center gap-2 text-xl md:text-2xl font-bold text-foreground mb-3">
      ...
      <div className="text-center my-6 md:my-10 max-w-3xl">
        ...
        <p className="text-lg md:text-xl text-foreground font-bold my-2">
